...
if (isset($_POST['send'])) {
  ...
  $userid = intval([$_SESSION['id']]) ;
    ...
    $insert = "INSERT INTO `order_item` VALUES (null, $proudect_id, default, default, $userid)";
                                        ...
                                        <th class="ps-0 py-3 border-light" scope="row">
                                            <div class="d-flex align-items-center"><a
                                                    class="reset-anchor d-block animsition-link" href="detail.php"><img
                                                        src="/shop/prodects/upload/<?php echo $img ?>" alt="..."
                                                        width="70" /></a>
                                                <div class="ms-3"><strong class="h6"><a
                                                            class="reset-anchor animsition-link"
                                                            href="detail.php"><?php echo $name ?></a></strong></div>
                                            </div>
                                        </th>
                            ...
                            <div class="row align-items-center text-center">
                                ...
                                <form method="POST">
                                    <div class="col-md-6 text-md-end">
                                        ...
                                        <button class="btn btn-outline-dark btn-sm" name="send" type="submit">CHECK
                                            OUT</button>

                                        <i class="fas fa-long-arrow-alt-right ms-2"></i></input>
                                    </div>
                                </form>
                            </div>
                        </div>
