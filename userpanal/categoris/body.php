                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        ...
                        <div class="py-2 px-4 bg-dark text-white mb-3"><strong
                                class="small text-uppercase fw-bold">Electronics
                            </strong></div>
                        <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                            <li class="mb-2"><a class="reset-anchor" href="laptop.php">LAPTop</a></li>
                            <li class="mb-2"><a class="reset-anchor" href="mobile.php">mobile</a></li>
                            <li class="mb-2"><a class="reset-anchor" href="tablet.php">Tablet</a></li>
                            <li class="mb-2"><a class="reset-anchor" href="whatches.php">whatches</a></li>
