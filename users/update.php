...
if (isset($_GET['edit'])) {
    ...
    if (isset($_POST['send'])) {
        ...
        $update = "UPDATE `users` SET `username`='$username',`email`='$email',`password`='$password',`phone`='$phone',`countery`='$countery',`name`='$name',`img`='$img_name' WHERE id=$id";
        ...
        <div class="card-body pt-0">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input value="<?php echo $username ?>" class="form-control" name="username" id="exampleInputEmail1"
                        type="text" aria-describedby="emailHelp">
                </div>

                <div class="mb-3">
                    <label class="form-label">Full Name</label>
                    <input class="form-control" value="<?php echo $row['name']; ?>" name="name" id="exampleInputEmail1"
                        type="text" aria-describedby="emailHelp">

                </div>
                <div class="mb-3">
                    <label class="form-label">Email address</label>
                    <input class="form-control" name="email" value="<?php echo $email ?>" id="exampleInputEmail1"
                        type="email" aria-describedby="emailHelp">

                </div>
                <div class="mb-3">
                    <label class="form-label" for="exampleInputPassword1">Password</label>
                    <input class="form-control" id="exampleInputPassword1" value="<?php echo $password ?>"
                        name="password" type="text">
                </div>
                <div class="mb-3">
                    <label>Enter your phone number:</label>
                    <input id="phone" type="tel" value="<?php echo $phone ?>" name="tel" />
                ...
                <div class="mb-3">
                    ...
                    <select value="<?php echo $countery ?>" name="countery" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <button class="btn btn-primary" name="send" type="submit">update</button>
            </form>
        </div>
    </div>
</div>
