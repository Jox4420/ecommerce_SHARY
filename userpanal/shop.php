                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        ...
                        <div class="py-2 px-4 bg-dark text-white mb-3"><strong
                                class="small text-uppercase fw-bold">Fashion &amp;
                                Acc</strong></div>
                        <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                            <li class="mb-2"><a class="reset-anchor" href="categoris/laptop.php">LAPTop</a></li>
                            <li class="mb-2"><a class="reset-anchor" href="categoris/mobile.php">mobile</a></li>
                            <li class="mb-2"><a class="reset-anchor" href="categoris/tablet.php">Tablet</a></li>
                            <li class="mb-2"><a class="reset-anchor" href="categoris/whatches.php">whatches</a></li>
                                    ...
                                    <div class="product text-center">
                                        <div class="mb-3 position-relative">
                                            <div class="badge text-white bg-"></div><a class="d-block"
                                                href="detail.php?show=<?php echo $data['id'] ?>"><img
                                                    class="img-fluid w-100"
                                                    src="../prodects/upload/<?php echo $data['img'] ?>" alt="..."></a>
                                            <div class="product-overlay">
                                                <ul class="mb-0 list-inline">
                                                    ...
                                                    <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark"
                                                            href="cart.php?cart=<?php echo $data['id'] ?>"">Add to
                                                            cart</a></li>
