                        ...
                        <div class="row align-items-stretch">
                            ...
                            <div class="col-lg-6">
                                <div class="p-4 my-md-4">
                                    ...
                                    <h2 class="h4"><?php echo $row['proname'] ?></h2>
            ...
            <div class="container">
                <div class="row mb-5">
                            ...
                            <div class="swiper product-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                            href="../prodects/upload/<?php echo $row['img'] ?>" data-gallery="gallery2"
                                            data-glightbox="Product item 1"><img class="img-fluid"
                                                src="../prodects/upload/<?php echo $row['img'] ?>" alt="..."></a>
                                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="text-muted lead"><?php echo $row['price'] ?></p>
                        <p class="text-sm mb-4"><?php echo $row['dis'] ?></p>
                ...
                <div class="tab-content mb-5" id="myTabContent">
                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <div class="p-4 p-lg-5 bg-white">
                            ...
                            <p class="text-muted text-sm mb-0"><?php echo $row['dis'] ?>
                            </p>
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="ms-3 flex-shrink-1">
                                            ...
                                            <p class="text-sm mb-0 text-muted">Lorem ipsum dolor sit amet,
                                                consectetur
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="product text-center skel-loader">
                                <div class="d-block mb-3 position-relative"><a class="d-block" href="detail.html"><img
                                            class="img-fluid w-100" src="../prodects/upload/<?php echo $data['img'] ?>"
                                            alt="..."></a>
                                ...
                                <h6> <a class="reset-anchor" href="detail.html"><?php echo $data['proname'] ?></a></h6>
                                <p class="small text-muted"><?php echo $data['price'] ?></p>
                            </div>
                        </div>
                    <?php } ?>
        </section>
